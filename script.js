...
const FALLBACK_DATA = [
    {
        ...
        description: "A premium analytics dashboard for online retailers featuring real-time data visualization and inventory management.",
        language: "React",
        stargazers_count: 12,
        forks_count: 4,
        html_url: "#"
    },
    {
        ...
        description: "Interactive web tool to visualize how simple neural networks learn patterns in real-time using Canvas API.",
        language: "Python",
        stargazers_count: 28,
        forks_count: 9,
        html_url: "#"
    },
    {
        ...
        description: "A minimalist productivity application with drag-and-drop interface and local storage synchronization.",
        language: "JavaScript",
        stargazers_count: 8,
        forks_count: 2,
        html_url: "#"
